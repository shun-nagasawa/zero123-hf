...
def main_run(models, device, cam_vis, return_what,
    ...
    if 'vis' in return_what:
        ...
        query_pose = [[x, y, z]]
        output_ims = models['turncam'](input_imgs=input_im, prompt_imgs=input_im, poses=query_pose, height=h, width=w,
                            guidance_scale=scale, num_images_per_prompt=n_samples, num_inference_steps=ddim_steps).images
...
def run_demo(
    ...
    models['turncam'] = load_model_from_config(model_id, device)
